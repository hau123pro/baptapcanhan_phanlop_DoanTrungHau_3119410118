...
{
    [DbContext(typeof(BTPhanLopDBContext))]
    [Migration("20221124053428_UpdateColumnTypeMonthPay")]
    partial class UpdateColumnTypeMonthPay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BT_PhanLop.Entity.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BT_PhanLop.Entity.PaymentRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BT_PhanLop.Entity.TaxYear", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BT_PhanLop.Entity.PaymentRecord", b =>
                {
                    b.HasOne("BT_PhanLop.Entity.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BT_PhanLop.Entity.TaxYear", "TaxYear")
                        .WithMany()
